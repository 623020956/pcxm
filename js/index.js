...
//                 str+='<div class="city-common" id="city-'+data[i].title+'">'
//                         +'<p>'+data[i].title+'</p>'
//                         +'<ul class=" city-common-list">'
//                         +'</ul>'
//                     +'</div>'

//                 // for (var j = 2; j < data[0].list[0].list1.length; j++) {
//                 console.log(data[0].list[0])
//                 str+=+'<ul class=" city-common-list">'
//                     +'<li></li>'
//                     +'</ul>'
                
//                 }
//             }
//             $(".city-menu").append(str);
